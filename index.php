                        ...
                        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
					            ...
					            <!--    <p class="byline vcard">By: <?php printf(get_the_author_link()); ?> </p> -->
										...
										<?php printf( __( "by "'<span class="author">%3$s</span> <time class="updated" datetime="%1$s" pubdate>%2$s</time>', 'bonestheme' ), get_the_time('Y-m-j'), get_the_time(get_option('date_format')), the_author_posts_link( get_the_author_meta( 'ID' ) )); ?>
									</p>
